...
async def test_fetch_telegram_users_batch(monkeypatch):
    from vanessa.infrastructure.ingest.telegram_users import fetch_telegram_users
    ...
    monkeypatch.setattr(
        "vanessa.infrastructure.ingest.telegram_users.fetch_telegram_user",
        fake_fetch,
    )
    monkeypatch.setattr("vanessa.infrastructure.ingest.telegram_users.asyncio.sleep", AsyncMock())
