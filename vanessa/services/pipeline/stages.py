...
from vanessa.decision.gate.ignore_registry_protocol import ChatIgnoreRegistryProtocol
from vanessa.decision.repeated_question import is_repeated_message
from vanessa.decision.repeated_loop import LoopRegistry, loop_registry as default_loop_registry
from vanessa.decision.gate.protocols import (
...
from vanessa.llm.format.reply_format import strip_trailing_periods
from vanessa.llm.format.sticker_tag import extract_sticker_tag
from vanessa.llm.photo_request import is_photo_request
from vanessa.llm.planner.turn_planner import TurnPlan
from vanessa.llm.prompts.session_format import session_context_messages
from vanessa.observability.metrics import (
    record_photo_request_missed,
    record_photo_send,
    record_web_search,
)
from vanessa.observability.tracing import get_tracer
from vanessa.rag.search.react_retriever import retrieve_with_react
from vanessa.rag.search.search_plan import build_main_rag_plan
from vanessa.services.humor_pipeline import HumorPipelineProtocol
...
from vanessa.services.pipeline.gate_support import (
